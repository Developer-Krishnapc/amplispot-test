...
firebase-dev:
	flutterfire config --out=lib/firebase/firebase_options_dev.dart --ios-bundle-id=com.amplispot.test.dev --android-app-id=com.amplispot.test.dev
	
firebase-stag:
	flutterfire config --out=lib/firebase/firebase_options_stag.dart --ios-bundle-id=com.amplispot.test.stag --android-app-id=com.amplispot.test.stag
	
firebase-prod:
	flutterfire config --out=lib/firebase/firebase_options_prod.dart --ios-bundle-id=com.amplispot.test --android-app-id=com.amplispot.test